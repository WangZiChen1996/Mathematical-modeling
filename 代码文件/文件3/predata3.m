...
clear all
%% 读取数据
deltatime=xlsread('文件3时间.xlsx');%导入文件3时间数据（秒）
[num,txt]=xlsread('文件3.xlsx');  % 导入文件3数据

data = [deltatime num];      %合并数据集
[m,n]=size(data);           %m=145825,n=14
